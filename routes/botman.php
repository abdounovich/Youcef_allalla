...
$botman->hears('steps', function($bot) {
    ...
    $bot->reply(' لزبون الحق في ارجاع أو تغيير المنتوج مع توضيح السبب وذلك خلال 24 ساعة الاولى بعد تأكيد استلام المنتوج من طرف نظام YALIDINE،
     وذلك بعد إعادة تغليف المنتوج كما كان وإرساله مع خدمة البريد السريع YALIDINE');
