...
<div class="d-flex fixed-bottom flex-center bg-info mb-0">
    ...
    <div class="p-3 btn-link  text-center flex-fill"><a href="/produits"><i class="text-white fa   fa-cubes" style="font-size: 22px"></i></a></div>

    <div class="p-3 btn-link active  bg-light   btn flex-fill "><a href="/clients"><i class="text-info fa  fa-users" style="font-size: 20px"></i></a></div>
    <div class="p-3 btn flex-fill"><a href="/"><i class="text-white fa   fa-shopping-cart" style="font-size: 20px"></i></a></div>
    <div class="p-3 btn flex-fill"><a href="/"><i class="text-white fa   fa-list" style="font-size: 20px"></i></a></div>
  </div>
@endsection
