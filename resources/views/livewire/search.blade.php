...
<div class="col col-10 ml-4">
  ...
  <style>
    ...
    <div class="card bg-dark text-white p-2 mt-5 shadow-lg" >
      <img class="card-img-top img-thumbnail" style="width: 300px; height:300px;margin: 0 auto;" src="{{$produit->photo}}" alt="Card image">
      <div class="card-body">
    ...
    echo '   <p class="card-text text-info h5  "> <del class="text-danger">'.$produit->prix.' da  </del> 
        ...
        echo"<p class='card-text text-primary h5'>Prix d'achat: ".$produit->achat."da</p>";
    echo"<p class='card-text text-success h5'>Bénéfice: ".(($remises->prix) - ($produit->achat))."da</p>";
    }
