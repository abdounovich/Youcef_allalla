...
{{--             <input class="btn btn-dark btn-circle text-white " value="X"  type="button" wire:click="changetype('all')" name="categorie" >        
 --}}            <input class="btn btn-secondary col col-3 m-1  " value="{{$commandes1->count()}}" type="button" wire:click="changetype('1')" name="categorie" id="inlineRadio1" >
                    <input class="btn btn-primary  col col-3 m-1  " value="{{$commandes2->count()}}" type="button" wire:click="changetype('2')" name="categorie" id="inlineRadio2" >
                    <input class="btn btn-warning  col col-3 m-1  " value="{{$commandes6->count()}}" type="button" wire:click="changetype('6')" name="categorie" id="inlineRadio1" >
                    <input class="btn btn-success  col col-3 m-1  " value="{{$commandes3->count()}}" type="button" wire:click="changetype('3')" name="categorie" id="inlineRadio1" >
                    <input class="btn btn-danger  col col-3 m-1 " value="{{$commandes4->count()}}" type="button" wire:click="changetype('4')" name="categorie" id="inlineRadio2" >
                    <input class="btn btn-orange text-white m-1   col col-3 " value="{{$commandes5->count()}}"  type="button" wire:click="changetype('5')" name="categorie" >        
                </div>
