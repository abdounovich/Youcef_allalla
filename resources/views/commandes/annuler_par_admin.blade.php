<div class="row text-center text-white mb-3">
    ...
    <h1 class=" h4 mt-4 p-3 shadow bg-dark rounded" style="opacity: 0.9"> commandes annulées par l'admin :  {{$annuler_par_admin_count}}</h1>
    </div>
</div>
...
<br>
    ...
    <div class="d-flex justify-content-center m-4">{{$annuler_par_admin->links()}}</div>
