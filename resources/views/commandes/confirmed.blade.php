<div class="row text-center text-white mb-3">
    <div class="col-lg-7 mx-auto">
        <h1 class=" h4 mt-4 p-3 shadow bg-dark rounded" style="opacity: 0.9"> commandes confirmées :{{$active_commandes_count}} </h1>
    </div>
</div>
    @foreach ($active_commandes as $commande)
    <div class=" btn card bg-primary border-dark  mt-2 mb-1" >
    ...
    </a><a class="btn btn-success btn-circle float-right  mt-2 mr-1" href="{{route('commandes.delivration',$commande->id) }}">
    ...
    <a class="btn btn-warning btn-circle float-right  mt-2 mr-1" href="{{route('commandes.return',$commande->id) }}">
        <span class="text-white  fa fa-repeat border-dark   "></span>
    </a>
...
<div class=" text-white mr-2">
 <div class=" float-right col col-12  "><i class=" text-warning fa fa-shopping-cart  ">
     </i><span class="mr-3 ml-2 ">commandes : {{$commande->client->commandes->count()}}</span>
...
<br>
    ...
    <div class="d-flex justify-content-center m-4">{{$active_commandes->links()}}</div>
