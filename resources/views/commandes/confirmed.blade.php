 ...
 <div class="row text-center text-white mb-3">
    ...
    <h1 class=" h4 mt-4 p-3 shadow bg-dark rounded" style="opacity: 0.9"> commandes non confirmées :  {{$active_commandes_count}}</h1>
    </div>
</div>
    ...
    if (!$remises) {
echo"<p class='card-text text-white mt-3 mt-3 h5'>prix : ".$commande->product->prix."da </p>";
}else {
