@php
   ...
   <div class="mt-2" ><span class="  text-secondary float-left">{{$commande->created_at->DiffForHumans()}}  <span class="  text-secondary float-right">{{$commande->product->code_interne}}</span></span>
</div>
