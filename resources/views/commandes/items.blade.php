@php
   ...
   <div class="card-text  text-white mt-1  h5"> {{$commande->total_price}} da 
    <span class="text-white float-right">Total:</span><span class="badge ml-2 float-right  mr-1 float-sm-right text-white  badge-success">   {{$commande->total_price}} Da  </span>
