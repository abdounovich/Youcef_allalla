...
<div class="d-flex fixed-bottom flex-center bg-info mb-0 mt-5">
    ...
    <div class="p-3 btn-link active  bg-light  text-center flex-fill"><a href="/products"><i class="text-info fa   fa-cubes" style="font-size: 22px"></i></a></div>
    <div class="p-3   btn flex-fill "><a href="/clients"><i class="text-white fa  fa-users" style="font-size: 20px"></i></a></div>
    <div class="p-3 btn flex-fill"><a href="/commandes"><i class="text-white fa   fa-shopping-cart" style="font-size: 20px"></i></a></div>
  </div>
@endsection
